...
//        Student student = new Student(2222, "Tushyap", "Lucknow");
        ...
        while(go) {
            ...
            try {
            	...
            	case 1:
            		...
            		//Saving student to database by calling insert of student DAO
            	...
            	case 5:
            		//update  student
            		System.out.println("Update Student by Entering Details");
            		System.out.println("Enter userId : ");
            		int userID=Integer.parseInt(br.readLine());
            		System.out.println("Enter user name : ");
            		...
            		objStudent.setStudentId(userID);
            		objStudent.setStudentName(userName);
            		objStudent.setStudentCity(usercity);
            		
            		studentDao.updateStudent(objStudent);
